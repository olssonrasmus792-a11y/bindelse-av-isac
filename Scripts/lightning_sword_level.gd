...
func _ready() -> void:
	level.text = "Level " + str(GameState.lightning_sword_level)
	xp.text = str(GameState.lightning_sword_xp) + "/" + str(GameState.lightning_sword_xp_needed) + " xp"
